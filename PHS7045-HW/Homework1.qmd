...
## Run Simulation 100k times

```{r}
n_trials <-100000
rmatch_outcomes <- replicate(n_trials, simulation_RAR(prob = c(0.35, 0.45, 0.55, 0.65)))
Rmatch_result <- as.data.frame(t(rmatch_outcomes))
Rmatch <- round(colMeans(Rmatch_result)*100,2)
f40_outcomes <- replicate(n_trials, simulation_ER(prob = c(0.35, 0.45, 0.55, 0.65)))
...
Probably gonna take around 50 minutes.
